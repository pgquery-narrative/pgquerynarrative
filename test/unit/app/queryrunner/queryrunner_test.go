...
func TestValidator(t *testing.T) {
	...
	tests := []struct {
		...
		{"explain_format_json_buffers", "EXPLAIN (FORMAT JSON, BUFFERS) SELECT * FROM demo.sales WHERE date >= CURRENT_DATE - INTERVAL '30 days'", errors.ErrExplainOptionsNotAllowed},
