...
<p align="center"><sub>Live UI walkthrough (10M-row seed): <code>DATE_TRUNC</code> → finding → range rewrite → compare (partitions 50→1). Re-record with <code>make demo-gif-credible</code>.</sub></p>
