...
// New instantiates HTTP handlers for all the investigations service endpoints
...
func (s *Server) Service() string { return "investigations" }
...
func (s *Server) MethodNames() []string { return investigations.MethodNames[:] }
...
// MountCreateHandler configures the mux to serve the "investigations" service
// "create" endpoint.
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/v1/investigations", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "investigations" service "create" endpoint.
...
// MountListHandler configures the mux to serve the "investigations" service
// "list" endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/v1/investigations", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "investigations" service "list" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountGetHandler configures the mux to serve the "investigations" service
// "get" endpoint.
func MountGetHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/v1/investigations/{id}", f)
}

// NewGetHandler creates a HTTP handler which loads the HTTP request and calls
// the "investigations" service "get" endpoint.
func NewGetHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountAddCandidateHandler configures the mux to serve the "investigations"
// service "add_candidate" endpoint.
func MountAddCandidateHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/api/v1/investigations/{id}/candidate", f)
}

// NewAddCandidateHandler creates a HTTP handler which loads the HTTP request
// and calls the "investigations" service "add_candidate" endpoint.
func NewAddCandidateHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeAddCandidateRequest(mux, decoder)
		encodeResponse = EncodeAddCandidateResponse(encoder)
		encodeError    = EncodeAddCandidateError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
...
// MountRankCandidatesHandler configures the mux to serve the "investigations"
// service "rank_candidates" endpoint.
func MountRankCandidatesHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/api/v1/investigations/{id}/rank-candidates", f)
}

// NewRankCandidatesHandler creates a HTTP handler which loads the HTTP request
// and calls the "investigations" service "rank_candidates" endpoint.
func NewRankCandidatesHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
	encoder func(context.Context, http.ResponseWriter) goahttp.Encoder,
	...
	var (
		decodeRequest  = DecodeRankCandidatesRequest(mux, decoder)
		encodeResponse = EncodeRankCandidatesResponse(encoder)
		encodeError    = EncodeRankCandidatesError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "rank_candidates")
		ctx = context.WithValue(ctx, goa.ServiceKey, "investigations")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
...
// MountGenerateReportHandler configures the mux to serve the "investigations"
// service "generate_report" endpoint.
func MountGenerateReportHandler(mux goahttp.Muxer, h http.Handler) {
	f, ok := h.(http.HandlerFunc)
	if !ok {
		f = func(w http.ResponseWriter, r *http.Request) {
			h.ServeHTTP(w, r)
	...
	mux.Handle("POST", "/api/v1/investigations/{id}/report", f)
}

// NewGenerateReportHandler creates a HTTP handler which loads the HTTP request
// and calls the "investigations" service "generate_report" endpoint.
func NewGenerateReportHandler(
	...
	var (
		decodeRequest  = DecodeGenerateReportRequest(mux, decoder)
		encodeResponse = EncodeGenerateReportResponse(encoder)
		encodeError    = EncodeGenerateReportError(encoder, formatter)
	)
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		ctx := context.WithValue(r.Context(), goahttp.AcceptTypeKey, r.Header.Get("Accept"))
		ctx = context.WithValue(ctx, goa.MethodKey, "generate_report")
		ctx = context.WithValue(ctx, goa.ServiceKey, "investigations")
		payload, err := decodeRequest(r)
		if err != nil {
			if err := encodeError(ctx, w, err); err != nil && errhandler != nil {
