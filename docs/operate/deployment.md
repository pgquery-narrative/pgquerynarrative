...
| Helm | [`deploy/helm/pgquerynarrative/`](https://github.com/pgquery-narrative/pgquerynarrative/tree/main/deploy/helm/pgquerynarrative) | Preferred for real deployments |
...
services:
  app:
    image: ghcr.io/pgquery-narrative/pgquerynarrative:2.2.0
```
...
**Access:** no Ingress — `kubectl port-forward -n pgquerynarrative svc/pgquerynarrative 8080:8080`
...
| Helm | `deploy/helm/pgquerynarrative/` | Parameterized install, the preferred path |
