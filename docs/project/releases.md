...
- `main` is the default branch; all releases are cut from it. `stable-v2.0.0` and
  `stable-v1.0.0` preserve the earlier major lines.
- Release versions are Git tags: `vMAJOR.MINOR.PATCH` (e.g. `v2.2.0`). No leading
  `v` in `changelog/released/` filenames (`MAJOR.MINOR.PATCH.md`, e.g. `2.2.0.md`).
